...
enum category               {  Program,      VarDecl,      FuncDecl,     FuncHeader,   FuncParams,   FuncBody,     ParamDecl,    Assign,       Int,         Natural,   Decimal,        Float32,        Bool,        String,        Identifier,   StrLit,       For,          If,           Block,        Call,         Return,       Print,        ParseArgs,    Or,           And,          Eq,           Ne,           Lt,           Le,           Gt,           Ge,           Add,          Sub,          Mul,          Div,          Mod,          Not,          Minus,        Plus,         AUX,          None};
#define CATEGORY_NAMES      { "Program",    "VarDecl",    "FuncDecl",   "FuncHeader", "FuncParams", "FuncBody",   "ParamDecl",  "Assign",     "Int",       "Natural", "Decimal",      "Float32",      "Bool",      "String",      "Identifier", "StrLit",     "For",        "If",         "Block",      "Call",       "Return",     "Print",      "ParseArgs",  "Or",         "And",        "Eq",         "Ne",         "Lt",         "Le",         "Gt",         "Ge",         "Add",        "Sub",        "Mul",        "Div",        "Mod",        "Not",        "Minus",      "Plus",       "AUX"         "None"};
